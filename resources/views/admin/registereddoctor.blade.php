    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
        <div align="right">
          <button type="button" name="create_record" id="create_record" class="btn btn-success btn-sm">Add Doctor</button>
        </div>
        <br />
      <div class="table-responsive">
        <table id="user_table" class="table table-bordered table-striped">
          <thead>
            <tr>
              <th width="1%">Doctor Name</th>
              <th width="1%">Doctor Email</th>
              <th width="1%">Doctor Phone</th>
              <th width="1%">Role</th>
          ...
          <div class="modal-body">
            ...
            <form method="post" id="sample_form" class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <input type="text" name="name" id="name" placeholder="Enter Here Doctor Name" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-8">
                  <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" placeholder="Your Phone" required>
...
$(document).ready(function(){
  ...
  $('#sample_form').on('submit', function(event){
    ...
    if($('#action').val() == 'Add')
    {
      action_url = "{{ route('adddoctor.store') }}";
    }

    if($('#action').val() == 'Edit')
    {
      action_url = "{{ route('adddoctor.update') }}";
    }
