...
<div class="inner-banner inner-bg9" style="height: 140px !important" >
    <div class="container" >
        <div class="" style="position: absolute !important; top: 40px;left: 520px;  margin: auto;" >
            <h2 style="color: white" >Doctor List</h2>
        </div >
    </div >
...
<div class="subscribe-area ptb-100" >
    <div class="container" >
        <div class="newsletter-area" >
            <h2 style="margin-top: -50px !important" >Find <b >Your</b > Specialist</h2 >
            <form class="newsletter-form"  method="get" >
                <input type="text" class="form-control" placeholder="Enter your Specialist Name" name="search" value="{{$search}}" required autocomplete="off" >
        ...
        <div class="tab doctor-tab text-center" >
           ...
           @foreach ($doctor as $doctors)
                            <div class="col-lg-4 col-md-6" >
                                <div class="doctors-item" >
                                    <div class="doctors-img" title="Click to view details" >
                                        <a href="doctors-details.html" >
                                            <img src="{{ asset('uploads/doctor/' . $doctors->images) }}" alt="Images" >
                                        </a >
                                    </div >
                                    <div class="content" >
                                        <h3 ><a href="{{ route('doctorview.show', $doctors->user_id) }}" >{{$doctors->name}}</a ></h3 >
                                        <span >{{$doctors->department}}</span >
                                        <p style="font-size: 12" >Email: {{$doctors->email}}
                                            <br >Phone Number: {{$doctors->phone}}</p >
                                        <button type="submit" class="default-btn" onclick="location.href='{{ route('patient.edit', $doctors->id) }}'"
                             ...
                             @endforeach
               @else
        <p class="mt-5 text-center mb-5">We don't have Find Any Doctor</p>
       @endif
