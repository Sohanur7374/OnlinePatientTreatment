          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted">
               ...
               <marquee> <span class="label label-success">Profile Is  Updated</span></marquee>
              </p>
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="profile">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" name="name" vvalue="{{$user->name}}" placeholder="Name">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" placeholder="Department Name" name="department" value="{{$user->department}}">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" placeholder="Department Name" name="hospital" value="{{$user->hospital}}">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" id="inputExperience" placeholder="Experience" name="experience">{{$user->experience}}</textarea>
                    </div>
                  </div>
                  <div class="form-group">
